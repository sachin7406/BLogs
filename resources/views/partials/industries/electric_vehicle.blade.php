        ...
        <div class="row">
            <div class="column column_bg">
                <div class="column_text">
                    ...
                    <h4>Moving electric vehicle manufacturing into the fast lane</h4>
                    <p>
            ...
            <div class="column">
                <img src="{{ asset('assets/images/imagesimcenter/Electric-vehicle.jpg')}}" class="img-fluid" alt="A&D">
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 shadow p-5 bg-light rounded ">
                <h3 class="mb-3 text-uppercase font-weight-normal">
                ...
                <div>
                    <h5 class="mb-3">The recent and rapid growth of electric vehicles (EVs) is driven by several factors</h5>
                    <li>
...
<section class="simcenter_3d_accordian_section">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h3 class="simcenter_3d_accordian_text">Featured Solutions</h3>
                <button class="accordion active">Vehicle Lightweighting</button>
                ...
                <button class="accordion">Harness Manufacturing Engineering</button>
                <div class="panel">
                    <p>
                ...
                <button class="accordion">Electric Motors Design & Simulation</button>
                <div class="panel">
                    <p>
                ...
                <button class="accordion">Battery Modeling and Simulation</button>
                <div class="panel">
                    <p>
                ...
                <button class="accordion">Power Electronics Simulation & Testing</button>
                <div class="panel">
                    <p>
