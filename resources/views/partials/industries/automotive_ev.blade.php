        ...
        <div class="row">
            <div class="column column_bg">
                <div class="column_text">
                    <h3>Faster, more efficient automotive design </h3>
                    <p>
...
<!----Automotive & Transportation------simcenter3D-----start------>
<section class="simcenter_3d_section">
    <div class="container">
        <div class="row">
...
<!----Automotive & Transportation------simcenter3Dt-----end------>
<!----Automotive & Transportation------Simcenter FloEFD -----start------>
<section class="simcenter_3d_section">
    <div class="container">
        <div class="row">
            <div class="col-md-12 col-sm-6 cgfc-box-1">
                <div class="column_text">
                    ...
                    <a href="/solutions/Simulation/floefd" class="btn btn-link">read more</a>
                </div>
            </div>
        </div>
    </div>
</section>
<!----Automotive & Transportation------Simcenter FloEFD -----end------>
<!----Automotive & Transportation------simcenter3D-----start------>
<section class="simcenter_3d_section">
    <div class="container">
        <div class="row">
            <div class="col-md-12 col-sm-6 cgfc-box-2">
                <div class="column_text">
                    ...
                    <a href="/solutions/Simulation/simcenter-amesim" class="btn btn-link">read more</a>
                </div>
            </div>
        </div>
    </div>
