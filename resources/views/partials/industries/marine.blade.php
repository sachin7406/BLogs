    ...
    <div class="container">
        <div class="row">
            ...
            <div class="column">
                ...
                <img src="{{  asset('assets/images/imagesimcenter/marine.png')}}" class="img-fluid" alt="efficient automotive design ">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <button class="accordion active">1. Commercial Shipbuilding</button>
                <div class="panel">
                    <p>
                ...
                <button class="accordion">2. Naval Shipbuilding</button>
                <div class="panel">
                    <p>
                ...
                <button class="accordion">3. Marine Suppliers</button>
                <div class="panel">
                    <p>
                ...
                <button class="accordion">4. Yachts & Leisure</button>
                <div class="panel">
                    <p>
                ...
                <button class="accordion">5. Owners & Operators</button>
                <div class="panel">
                    <p>
