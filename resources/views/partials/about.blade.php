                        ...
                        <div class="row">
                            ...
                            <div class="carousel-text">
                                <div class="content-img">
                                    <img src="img/logo/siemens-logo.png" class="img-fluid">
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <section class="about-section">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="about-content">
                        <img src="image/about/about-dis.jpg" class="img-fluid " alt="about-dis">
                    </div>
                </div>
            </div>
    ...
    <section class="industry-section">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-3">
                    <a href="Industries/Aerospace-Defence.html">
                        <div class="container-sec">
                            <img src="image/industries logo/aero.png" alt="aerospace" class="image-sec img-fluid">
                ...
                <div class="col-md-3">
                    <a href="Industries/Automotive-Transportation(EV).html">
                        <div class="container-sec">
                            <img src="image/industries logo/shipment.png" alt="automotive trans" class="image-sec img-fluid">
                            <div class="overlay-sec">
                                <div class="text">
                                    <h6>Automotive </h6>
                                </div>
                ...
                <div class="col-md-3">
                    <a href="Industries/Consumer-Products-Retails.html">
                        <div class="container-sec">
                            <img src="image/industries logo/consumer.png" alt="comsumer" class="image-sec img-fluid">
                            <div class="overlay-sec">
                                <div class="text">
                ...
                <div class="col-md-3">
                    <a href="Industries/Electronics.html">
                        <div class="container-sec">
                            <img src="image/industries logo/electronics.png" alt="semiconductor" class="image-sec img-fluid">
                            <div class="overlay-sec">
                                <div class="text">
                                    <h6>Electronics </h6>
            ...
            <div class="row justify-content-center">
                <div class="col-md-3">
                    <a href="Industries/Industrial-Machinery-Heavy-Equipment.html">
                        <div class="container-sec">
                            <img src="image/industries logo/mechine.png" alt="industrial" class="image-sec img-fluid">
                            <div class="overlay-sec">
                                <div class="text">
                ...
                <div class="col-md-3">
                    <a href="Industries/Medical-Devices.html">
                        <div class="container-sec">
                            <img src="image/industries logo/device.png" alt="medical" class="image-sec img-fluid">
                            <div class="overlay-sec">
                                <div class="text">
                ...
                <div class="col-md-3">
                    <a href="Industries/Marine.html">
                        <div class="container-sec">
                            <img src="image/industries logo/marine.png" alt="marine icons" class="image-sec img-fluid">
                            <div class="overlay-sec">
                                <div class="text">
                                    <h6>Marine</h6>
    ...
    <section class="service-section">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="service-card">
                        <a href="CAE-Simulation/Structural-analysis/Modal-analysis/simcenter/Simcenter-3D.html" class="card-anchor">
                            <div class="img-hover-zoom">
                                <img src="DDS-image/Simcenter-3D-Wheel-2019.1-1024x1024.png" alt="1d" class="img-fluid">
                            </div>
                            <div class="img-body">
                                <h5>Simcenter 3D</h5>
                            </div>
                ...
                <div class="col-md-3">
                    <div class="service-card">
                        <a href="Heeds/Design-Optimization/CAE-Optimization/Simcenter/Simcenter-heeds.html" class="card-anchor">
                            <div class="img-hover-zoom">
                                <img src="DDS-image/HEEDS_processs_automation_tcm27-25264.png" alt="thermal_card01" class="img-fluid">
                            </div>
                            <div class="img-body">
                ...
                <div class="col-md-3">
                    <div class="service-card">
                        <a href="Motor-Design/Motor-Analysis/Simcenter/Simcenter-Motorsolve.html" class="card-anchor">
                            <div class="img-hover-zoom">
                                <img src="DDS-image/MotorSolve_Webbo_Image-78192920.jpg" alt="EMField" class="img-fluid">
                            </div>
                            <div class="img-body">
                ...
                <div class="col-md-3">
                    <div class="service-card">
                        <a href="Electric-machine-design/Simcenter/Simcenter-Speed.html" class="card-anchor">
                            <div class="img-hover-zoom">
                                <img src="DDS-image/Simcenter-Speed-features-250-190.png" alt="ANSYS-Multiphysics_Kopplung_Flow-Meter" class="img-fluid">
                            </div>
                            <div class="img-body">
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="service-card">
                        <a href="Battery-design/battery-simulations/Battery-CFD-analysis/Simcenter/Simcenter-BDS.html" class="card-anchor">
                            <div class="img-hover-zoom">
                                <img src="DDS-image/Simcenter-BDS-427-530.png" alt="Turbomachinery-simulation" class="img-fluid">
                            </div>
                            <div class="img-body">
                ...
                <div class="col-md-3">
                    <div class="service-card">
                        <a href="Electric-machine-simulations/electromagnetic-simulations/HFSS/Simcenter/Simcenter-Magnet.html" class="card-anchor">
                            <div class="img-hover-zoom">
                                <img src="DDS-image/Simcenter-Magnet-427-520.png" alt="WC-connecting-wires" class="img-fluid">
                            </div>
                            <div class="img-body">
                ...
                <div class="col-md-3 ">
                    <div class="service-card">
                        <a href="Prepost-solver/advanced-meshing-tool/CAE-Solution/Simcenter/Simcenter-Femap.html" class="card-anchor">
                            <div class="img-hover-zoom">
                                <img src="DDS-image/ECbhyddW4AAHNUv.jpg" alt="optimization" class="img-fluid">
                            </div>
                            <div class="img-body">
                ...
                <div class="col-md-3">
                    <div class="service-card">
                        <a href="Mechatronic-system-simulations/Simcenter/Simcenter-Amesim.html" class="card-anchor">
                            <div class="img-hover-zoom">
                                <img src="DDS-image/Amesim-wide-flow---250-190.png" alt="unnamed" class="img-fluid">
                            </div>
                            <div class="img-body">
						  ...
						  <div class="row mb-3">
							<div class="blog-col">
								<div class="blog-caption">
									<span class="badge  badge-light mb-2">New</span>
									<p>00 June, 2021</p>
									<h5>Lorem ipsum dolor sit </h5>
									<p>
										Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras pulvinar, sem nec pretium eleifend, tellus risus hendrerit nisi, at volutpat urna nulla tristique eros. Mauris ipsum lorem, lobortis vitae neque tincidunt.
									</p>		
									<a href="" target="blank" class="btn btn-learn">read more</a>
								</div>
							</div>
							<div class="blog-col">
                            ...
                            <div class="carousel-item active">
                                <div class="container">
                                    <div class="row mb-3">
                                        ...
                                        <div class="blog-col">
                                            <img src="image/blog/Blog-Title.jpg" class="img-fluid">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="carousel-item">
                                <div class="container">
                                    <div class="row mb-3">
                                        ...
                                        <div class="blog-col">
                                            <img src="image/blog/Go-Paperless-_June.png" class="img-fluid">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="carousel-item">
                                <div class="container">
                                    <div class="row mb-3">
                                        ...
                                        <div class="blog-col">
                                            <img src="image/blog/thermal_fatigue.jpg" class="img-fluid">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="carousel-item active">
                            <div class="container">
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="news-card">
                                            <img class="news-img-top" src="imagesimcenter/p3.jpg" alt="Card image cap">
                                            <div class="news-body">
                                                <p class="news-text">
                                    ...
                                    <div class="col-md-4">
                                        <div class="news-card">
                                            <img class="news-img-top" src="imagesimcenter/ThyssenKrupp.jpg" alt="Card image cap">
                                            <div class="news-body">
                                                <p class="news-text">
                                    ...
                                    <div class="col-md-4">
                                        <div class="news-card">
                                            <img class="news-img-top" src="imagesimcenter/Facebook-data-saver.jpg" alt="Card image cap">
                                            <div class="news-body">
                                                <p class="news-text">
                        ...
                        <div class="carousel-item">
                            <div class="container">
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="news-card">
                                            <img class="news-img-top" src="imagesimcenter/Hilti.webp" alt="Card image cap">
                                            <div class="news-body">
                                                <p class="news-text">
                                    ...
                                    <div class="col-md-4">
                                        <div class="news-card">
                                            <img class="news-img-top" src="imagesimcenter/Allseas.jpg" alt="Card image cap">
                                            <div class="news-body">
                                                <p class="news-text">
                                    ...
                                    <div class="col-md-4">
                                        <div class="news-card">
                                            <img class="news-img-top" src="imagesimcenter/World Auto Steel.jpg" alt="Card image cap">
                                            <div class="news-body">
                                                <p class="news-text">
                        ...
                        <div class="carousel-item">
                            <div class="container">
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="news-card">
                                            <img class="news-img-top" src="imagesimcenter/thermolift.jpg" alt="Card image cap">
                                            <div class="news-body">
                                                <p class="news-text">
                                    ...
                                    <div class="col-md-4">
                                        <div class="news-card">
                                            <img class="news-img-top" src="imagesimcenter/Amesim.png" alt="Card image cap">
                                            <div class="news-body">
                                                <p class="news-text">
                                    ...
                                    <div class="col-md-4">
                                        <div class="news-card">
                                            <img class="news-img-top" src="imagesimcenter/salcomp.jpg" alt="Card image cap">
                                            <div class="news-body">
                                                <p class="news-text">
