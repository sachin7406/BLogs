...
<section class="simcenter_3d_section">
    <div class="container">
        <div class="row">
            ...
            <div class="column">
                <img src="{{  asset('assets/images/imagesimcenter/Flotherm.png')}}" class="img-fluid" alt="Simcenter-FlothermXT">
            </div>
        </div>
    </div>
</section>
...
<section class="simcenter_3d_accordian_section">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h3 class="simcenter_3d_accordian_text">Why Simcenter Flotherm?</h3>
                <button class="accordion active">Modeling electronics assemblies</button>
                <div class="panel">
                    <p>
                ...
                <button class="accordion">Conduction, convection, radiation, phase change and solar loading materials</button>
                <div class="panel">
                    <p>
                ...
                <button class="accordion">Modeling chip packages</button>
                <div class="panel">
                    <p>
                ...
                <button class="accordion">Active thermal management strategies</button>
                <div class="panel">
                    <p>
                ...
                <button class="accordion">Fast, robust meshing and solution</button>
                <div class="panel">
                    <p>
                    ...
                    <img src="{{  asset('assets/images/image/simcenter 3d/Simcenter-Flotherm.jpg')}}" class="img-fluid mx-auto d-block p-5" alt="Simcenter-Flotherm" style="height:300px;">
                </div>
...
<section class="simcenter_3d_section">
    <div class="container">
        <div class="row">
            <div class="column">
                <img src="{{  asset('assets/images/imagesimcenter/flotherm-2.png')}}" class="img-fluid" alt="benifit solutions">
            </div>
            <div class="column column_bg_2">
                <div class="column_text">
                    <h3>Benefits of Flotherm</h3>
                    <ul class="simcenter_3d_ul">
                        ...
                        <li>Rapid model creation supported by Smartparts™</li>
                        <li>
