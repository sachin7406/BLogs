...
<section class="simcenter_3d_section">
    <div class="container">
        <div class="row">
            ...
            <div class="column">
                <img src="{{  asset('assets/images/imagesimcenter/3d.jpg')}}" class="img-fluid" alt="simcenter3d">
            </div>
        </div>
        <div class="row">
            <div class="column">
                <img src="{{  asset('assets/images/imagesimcenter/Simcenter-Wheel-250-270.png')}}" class="img-fluid" alt="Sim-3d" style="width:400px;height:400px;">
            </div>
            <div class="column column_bg_2">
                <div class="column_text ">
                    <p>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 col-sm-6 column_bg">
                <div class="column_text">
                    <h3>Benefits of using Simcenter 3D</h3>
                    <p>
...
<section class="simcenter_3d_accordian_section">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h3 class="simcenter_3d_accordian_text">simcenter 3D CAPABILITIES</h3>
                <button class="accordion active">Faster CAE Processes</button>
                ...
                <button class="accordion">MULTIDISCIPLINE INTEGRATION</button>
                <div class="panel">
                    <p>
                ...
                <button class="accordion">OPEN AND SCALABLE</button>
                <div class="panel">
                    <p>
                ...
                <button class="accordion">TIED INTO THE DIGITAL THREAD</button>
                <div class="panel">
                    <p>
                ...
                <button class="accordion">FLEXIBLE LICENSING</button>
                <div class="panel">
                    <p>
...
<section class="simcenter_3d_accordian_section">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h3 class="simcenter_3d_accordian_text">PHYSICS CAPABILITIES</h3>
                <button class="accordion active">Structural Simulation</button>
                <div class="panel">
                    <p>
                ...
                <button class="accordion">Response Dynamics</button>
                <div class="panel">
                    <p>
                    ...
                    <img src="{{  asset('assets/images/simcenter/DynamikTraining.png')}}" class="img-fluid mx-auto d-block p-5" style="height:auto;">
                </div>

                <button class="accordion">DURABILITY SIMULATION</button>
                <div class="panel">
                    <p>
                    ...
                    <img src="{{  asset('assets/images/simcenter/DURABILITY SIMULATION.jpg')}}" class="img-fluid mx-auto d-block p-5" style="height:auto;">
                </div>
                <button class="accordion">Acoustics SIMULATION</button>
                <div class="panel">
                    <p>
                    ...
                    <img src="{{  asset('assets/images/simcenter/Acoustics solutions.jpg')}}" class="img-fluid mx-auto d-block p-5" style="height:auto;">
                </div>
                <button class="accordion">MOTION CONTROL</button>
                <div class="panel">
                    <P>
                    ...
                    <img src="{{  asset('assets/images/simcenter/motion soluitons.jpg')}}" class="img-fluid mx-auto d-block p-5" style="height:auto;">
                </div>
                <button class="accordion">THERMAL SIMULATION</button>
                <div class="panel">
                    <p>
                    ...
                    <img src="{{  asset('assets/images/simcenter/Thermal_simulation.jpg')}}" class="img-fluid mx-auto d-block p-5" style="height:auto;">
                </div>
                <button class="accordion">Flow Simulation</button>
                <div class="panel">
                    <p>
                    ...
                    <img src="{{  asset('assets/images/simcenter/Flow_simulation.jpg')}}" class="img-fluid mx-auto d-block p-5" style="height:auto;">
                </div>
                <button class="accordion">ELECTROMAGNETIC SIMULATION</button>
                <div class="panel">
                    <p>
                    ...
                    <img src="{{  asset('assets/images/simcenter/electromagnetics-simulation.jpg')}}" class="img-fluid mx-auto d-block p-5" style="height:auto;">
                </div>
                <button class="accordion">Additive Manufacturing Simulation</button>
                <div class="panel">
                    <p>
                    ...
                    <img src="{{  asset('assets/images/simcenter/Additive Manufacturing Simulation.jpg')}}" class="img-fluid mx-auto d-block p-5" style="height:auto;">
                </div>

                <button class="accordion">Materials Engineering</button>
                <div class="panel">
                    <p>
                    ...
                    <img src="{{  asset('assets/images/simcenter/Materials Engineering.jpg')}}" class="img-fluid mx-auto d-block p-5" style="height:auto;">
                </div>
