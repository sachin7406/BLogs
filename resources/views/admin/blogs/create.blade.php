...
<div class="wp-topbar">
    ...
    <div class="wp-topbar-right">
        <button class="icon-btn active" id="settingsSidebarBtn" title="Toggle settings sidebar"
            style="font-size: 18px; background: #f3f5ff; border-radius: 6px; margin-right: 8px; padding: 7px 13px; border: 1px solid #dde3fa; color: #3858e9; box-shadow: 0 1px 3px rgba(56,88,233,0.07); transition: background 0.2s, box-shadow 0.2s;">
            <span style="font-size: 20px; vertical-align: middle;">⚙</span>
        </button>
        <button class="icon-btn" id="previewBtn" title="Preview"
            style="font-size: 18px; background: #f8f8fa; border-radius: 6px; margin-right: 8px; padding: 7px 13px; border: 1px solid #eee; color: #333; transition: background 0.2s, box-shadow 0.2s;">
            <span style="font-size: 18px; vertical-align: middle;">👁</span>
        </button>
        <button class="publish" id="publishBtn"
            style="background: linear-gradient(90deg, #3656ec 0%, #3e9aff 100%); border-radius: 6px; color: #fff; border: none; padding: 8px 22px; font-size: 16px; font-weight: 600; letter-spacing: 0.03em; box-shadow: 0 2px 8px rgba(56,88,233,0.10); transition: background 0.2s, box-shadow 0.2s; cursor: pointer;">
            Publish
        </button>
    </div>
</div>
...
<div class="wp-layout">
    ...
    <div class="wp-left" id="wpLeft">
        ...
        <div class="wp-left-tab-content" id="wpLeftTabBlocks">
            <div class="block-category">
                ...
                <div class="block-item" data-block="paragraph" draggable="true" title="Paragraph"><span
                        class="block-item-icon">¶</span><span class="block-item-text">Paragraph</span></div>
                <div class="block-item" data-block="heading" draggable="true" title="Heading"><span
                        class="block-item-icon">🔖</span><span class="block-item-text">Heading</span></div>
                <div class="block-item" data-block="list" draggable="true" title="List"><span
                        class="block-item-icon">≡</span><span class="block-item-text">List</span></div>
                <div class="block-item" data-block="quote" draggable="true" title="Quote"><span
                        class="block-item-icon">"</span><span class="block-item-text">Quote</span></div>
                <div class="block-item" data-block="code" draggable="true" title="Code"><span
                        class="block-item-icon">&lt;/&gt;</span><span class="block-item-text">Code</span></div>
                <div class="block-item" data-block="details" draggable="true" title="Details"><span
                        class="block-item-icon">≡</span><span class="block-item-text">Details</span></div>
                <div class="block-item" data-block="preformatted" draggable="true" title="Preformatted"><span
                        class="block-item-icon">☐</span><span class="block-item-text">Preformatted</span></div>
                <div class="block-item" data-block="table" draggable="true" title="Table" style="background:#f6f8fe;">
                    <span class="block-item-icon" style="color:#4066d7;">🗉</span><span class="block-item-text"
                        style="color:#4066d7;">Table</span>
                </div>
                <div class="block-item" data-block="classic" draggable="true" title="Classic"><span
                        class="block-item-icon">☐</span><span class="block-item-text">Classic</span></div>
            </div>
            <div class="block-category">
                <div class="block-category-title">MEDIA</div>
                <div class="block-item" data-block="image" draggable="true" title="Image"><span
                        class="block-item-icon">🖼</span><span class="block-item-text">Image</span></div>
            </div>

            <div class="block-category">
                <div class="block-category-title">DESIGN</div>
                <div class="block-item" data-block="accordion" draggable="true" title="Accordion"><span
                        class="block-item-icon">≡</span><span class="block-item-text">Accordion</span></div>
                <div class="block-item" data-block="buttons" draggable="true" title="Buttons"><span
                        class="block-item-icon">▢</span><span class="block-item-text">Buttons</span></div>
                <div class="block-item" data-block="columns" data-cols="picker" draggable="true" title="Columns"><span
                        class="block-item-icon">|||</span><span class="block-item-text">Columns</span></div>
                <div class="block-item" data-block="separator" draggable="true" title="Separator"><span
                        class="block-item-icon">—</span><span class="block-item-text">Separator</span></div>
                <div class="block-item" data-block="spacer" draggable="true" title="Spacer"><span
                        class="block-item-icon">↗</span><span class="block-item-text">Spacer</span></div>
            </div>
    ...
    <div class="wp-center">
        <div class="editor-wrapper" id="editorWrapper">
            <input class="editor-title" id="title" placeholder="Add title" value="{{ $isEdit ? e($blog->title) : '' }}">
            ...
            <div class="block-toolbar" id="blockToolbar">
                ...
                <div class="tb-section" id="tbTextSection" style="display:none;">
                    <select class="tb-select" id="tbBlockType" title="Block type" style="display:none;"
                        aria-hidden="true">
                    ...
                    <div class="tb-transform-wrap">
                        <button type="button" class="tb-btn tb-transform-btn" id="tbTransformBtn"
                            title="Transform to"><span id="tbTransformIcon">¶</span> <span
                                id="tbTransformLabel">Paragraph</span> ▾</button>
                        <div class="tb-transform-dropdown" id="tbTransformDropdown">
                            <div class="tb-transform-title">TRANSFORM TO</div>
                            <button type="button" class="tb-transform-option" data-transform="paragraph"><span
                                    class="tb-transform-icon">¶</span> Paragraph</button>
                            <button type="button" class="tb-transform-option" data-transform="h2"><span
                                    class="tb-transform-icon">🔖</span> Heading</button>
                            <button type="button" class="tb-transform-option" data-transform="list"><span
                                    class="tb-transform-icon">≡</span> List</button>
                            <button type="button" class="tb-transform-option" data-transform="quote"><span
                                    class="tb-transform-icon">"</span> Quote</button>
                            <hr class="tb-transform-hr">
                            <button type="button" class="tb-transform-option" data-transform="code"><span
                                    class="tb-transform-icon">&lt;/&gt;</span> Code</button>
                            <button type="button" class="tb-transform-option" data-transform="preformatted"><span
                                    class="tb-transform-icon">☐</span> Preformatted</button>
                            <button type="button" class="tb-transform-option" data-transform="details"><span
                                    class="tb-transform-icon">≡</span> Details</button>
                        </div>
                    </div>
        ...
        <div id="postSettings">
            ...
            <div class="settings-group">
                ...
                <div class="status-radio">
                    <label>
                        <input type="radio" name="status" value="active" {{ $isEdit ? ($blog->status === 'active' ? 'checked' : '') : 'checked' }}>
                        Active
                    </label>
                    <label>
                        <input type="radio" name="status" value="inactive" {{ $isEdit && $blog->status === 'inactive' ? 'checked' : '' }}>
                        Inactive
                    </label>
                </div>
            </div>
            ...
            <div class="settings-group" style="display: none;">
                ...
                <input type="text" id="slugInput" value="{{ $isEdit && !empty($blog->slug) ? e($blog->slug) : '' }}"
            ...
            <div class="settings-group">
                ...
                <select id="categorySelect"
                    style="width:100%;padding:6px;border:1px solid #dcdcde;border-radius:4px;margin-top:6px;">
        ...
        <div id="blockSettings" style="display: none;">
            ...
            <div id="blockInspector" style="display: none;">
                <div class="settings-group">
                    ...
                    <p id="blockInspectorDesc" class="block-inspector-desc">Introduce new sections and organize content.
                    </p>
                </div>
                ...
                <div class="settings-group" id="blockColorGroup">
                    ...
                    <div style="display:flex;align-items:center;gap:8px;margin-top:6px;">
                        <input type="color" id="blockColor" value="#1d2327"
                            style="width:36px;height:36px;border:1px solid #dcdcde;border-radius:4px;cursor:pointer;">
                        <span>Text</span>
                    </div>
                </div>
                <div class="settings-group" id="blockFormatGroup">
                    ...
                    <div class="settings-sub">
                        ...
                        <div style="display: flex; align-items: center; gap: 10px;">
                            <select id="blockFontSize"
                                style="width:100%;padding:8px;border:1px solid #dcdcde;border-radius:4px;margin-top:4px;flex:1;">
                            ...
                            <input id="blockFontSizeCustom" type="range" min="8" max="72" step="1" value="16"
                                style="display:none;width:120px;margin-left:8px;">
                    ...
                    <div class="settings-sub" style="margin-top:12px;">
                        ...
                        <select id="blockFontWeight"
                            style="width:100%;padding:8px;border:1px solid #dcdcde;border-radius:4px;margin-top:4px;">
                ...
                <div class="settings-group" id="blockButtonSettingsGroup" style="display:none;">
                    ...
                    <div class="settings-sub" style="margin-top:16px;">
                        ...
                        <input type="text" id="buttonUrl" placeholder="URL"
                            style="width:100%;padding:8px;border:1px solid #dcdcde;border-radius:4px;margin-top:4px;">
                        <input type="text" id="buttonText" placeholder="Text"
                            style="width:100%;padding:8px;border:1px solid #dcdcde;border-radius:4px;margin-top:4px;">
                        <select id="buttonLinkTarget"
                            style="width:100%;padding:8px;border:1px solid #dcdcde;border-radius:4px;margin-top:4px;">
                            <option value="_self">Same window</option>
                            <option value="_blank">New window</option>
                        </select>
                        <input type="text" id="buttonRel" placeholder="rel"
                            style="width:100%;padding:8px;border:1px solid #dcdcde;border-radius:4px;margin-top:4px;">
                        <button type="button"
                            style="width:100%;padding:6px;margin-top:8px;border:1px solid #dcdcde;background:#fff;border-radius:4px;cursor:pointer;">Reset
                            all</button>
                    </div>
                </div>
                <!-- Columns settings -->
                <div class="settings-group" id="blockColumnsSettingsGroup" style="display:none;">
                    ...
                    <div class="settings-sub">
                        ...
                        <div class="column-layout-mini" style="display:flex;flex-wrap:wrap;gap:6px;margin-top:8px;">
                            ...
                            <button type="button" class="layout-mini-btn" data-cols="2"
                                data-ratio="50-50">50/50</button>
                            <button type="button" class="layout-mini-btn" data-cols="2"
                                data-ratio="33-66">33/66</button>
                            <button type="button" class="layout-mini-btn" data-cols="2"
                                data-ratio="66-33">66/33</button>
                            <button type="button" class="layout-mini-btn" data-cols="3"
                                data-ratio="33-33-33">33/33/33</button>
                            <button type="button" class="layout-mini-btn" data-cols="3"
                                data-ratio="25-50-25">25/50/25</button>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="collapsible-content" style="display:none;margin-top:8px;">
                        <div style="display:grid;grid-template-columns:1fr 1fr;gap:8px;">
                            <div>
                                ...
                                <input type="number" id="blockWidth" placeholder="auto"
                                    style="width:100%;padding:6px;border:1px solid #dcdcde;border-radius:4px;margin-top:4px;">
                            </div>
                            <div>
                                <label style="font-size:11px;color:#50575e;">Height</label>
                                <input type="text" id="blockHeight" placeholder="auto"
                                    style="width:100%;padding:6px;border:1px solid #dcdcde;border-radius:4px;margin-top:4px;">
                            </div>
                        </div>
                        <div class="settings-sub" style="margin-top:12px;">
                            ...
                            <div class="block-settings-slider-row">
                                ...
                                <input type="text" id="blockPadding" class="block-settings-px" placeholder="0"
                                    value="0">
                ...
                <div class="settings-group collapsible" id="blockBorderGroup">
                    ...
                    <div class="collapsible-content" style="display:none;margin-top:8px;">
                        <div class="settings-sub">
                            <label>BORDER</label>
                            <div class="block-settings-slider-row">
                                <input type="range" id="blockBorderWidthSlider" min="0" max="20" value="0"
                                    title="Border width">
                                <input type="text" id="blockBorderWidth" class="block-settings-px" placeholder="0"
                                    value="0">
                                <span class="block-settings-link-icon" title="Link">⇔</span>
                            </div>
                        </div>
                        <div style="display:grid;grid-template-columns:1fr 1fr;gap:8px;margin-top:8px;">
                            ...
                            <div>
                                ...
                                <input type="color" id="blockBorderColor" value="#dcdcde"
                                    style="width:100%;height:36px;border:1px solid #dcdcde;border-radius:4px;margin-top:4px;cursor:pointer;">
                            </div>
                        </div>
                        <div class="settings-sub" style="margin-top:12px;">
                            <label>RADIUS</label>
                            <div class="block-settings-slider-row">
                                <input type="range" id="blockBorderRadiusSlider" min="0" max="50" value="0"
                                    title="Radius">
                                <input type="text" id="blockBorderRadius" class="block-settings-px" placeholder="0"
                                    value="0">
                                <span class="block-settings-link-icon" title="Link">⇔</span>
                            </div>
                        </div>
                ...
                <div class="settings-group collapsible" id="blockAttributesGroup">
                    ...
                    <div class="collapsible-content" style="display:none;margin-top:8px;">
                        ...
                        <p class="block-settings-attr-desc">Attributes connected to custom fields or other dynamic data.
                        </p>
                        <input type="text" id="blockHtmlAnchor" placeholder="HTML Anchor"
                            style="width:100%;padding:8px;border:1px solid #dcdcde;border-radius:4px;margin-top:12px;">
                        <input type="text" id="blockCssClass" placeholder="Additional CSS class(es)"
                            style="width:100%;padding:8px;border:1px solid #dcdcde;border-radius:4px;margin-top:8px;">
                    </div>
                </div>
                <div class="settings-group collapsible">
                    <strong class="collapsible-toggle">Advanced</strong>
                    <div class="collapsible-content" style="display:none;margin-top:8px;">
                        <textarea id="blockCustomCss" placeholder="Custom CSS"
                            style="width:100%;padding:8px;border:1px solid #dcdcde;border-radius:4px;min-height:80px;font-family:monospace;font-size:12px;"></textarea>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="column-layout-modal" id="columnLayoutModal">
        <div class="column-layout-content">
            ...
            <div class="column-layout-options" id="columnLayoutOptions">
                <button type="button" data-cols="1" data-ratio="100"><span class="cols-visual"><span
                            style="width:24px"></span></span> 100</button>
                <button type="button" data-cols="2" data-ratio="50-50"><span
                        class="cols-visual"><span></span><span></span></span> 50 / 50</button>
                <button type="button" data-cols="2" data-ratio="33-66"><span class="cols-visual"><span
                            style="width:6px"></span><span style="width:18px"></span></span> 33 / 66</button>
                <button type="button" data-cols="2" data-ratio="66-33"><span class="cols-visual"><span
                            style="width:18px"></span><span style="width:6px"></span></span> 66 / 33</button>
                <button type="button" data-cols="3" data-ratio="33-33-33"><span
                        class="cols-visual"><span></span><span></span><span></span></span> 33 / 33 / 33</button>
                <button type="button" data-cols="3" data-ratio="25-50-25"><span class="cols-visual"><span
                            style="width:6px"></span><span style="width:12px"></span><span
                            style="width:6px"></span></span> 25 / 50 / 25</button>
            </div>
            <a class="skip-link" id="columnLayoutSkip">Skip</a>
        </div>
    </div>
    <div class="modal fade" id="pasteCleanModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Clean pasted HTML?</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <p class="mb-0">Choose how to paste this content.</p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-outline-secondary" id="pasteKeepBtn">Keep source
                        formatting</button>
                    <button type="button" class="btn btn-primary" id="pasteCleanBtn">Clean HTML</button>
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    function getActiveEditable() {
        ...
        return active.closest ? active.closest('[contenteditable="true"]') : null;
    }

    function isEditingContext() {
        return !!getActiveEditable() || !!document.activeElement?.closest?.('#editor');
    }
    ...
    function saveState() {
        ...
        if (prev && prev.html === state.html && prev.title === state.title) {
            return;
        }
    ...
    function wrapBlock(el, type) {
        ...
        if (el.contentEditable === 'true') {
            ...
            el.addEventListener('keydown', (e) => {
                // Correctly handle Ctrl+Enter (or Cmd+Enter) for submitting/completing block
                if ((e.ctrlKey || e.metaKey) && e.key === 'Enter' && !e.shiftKey) {
                    e.preventDefault();
                    // Optionally blur to "commit" edit, or create a new paragraph block
                    // Here, we'll move focus to the next block or create a new paragraph
                    const currentBlock = el.closest('.block');
                    let nextBlock = currentBlock?.nextElementSibling;
                    if (nextBlock && nextBlock.querySelector('[contenteditable]')) {
                        nextBlock.querySelector('[contenteditable]').focus();
                    } else {
                        addParagraph();
                        setTimeout(() => {
    ...
    function addTable() {
        ...
        function createTableElement(rows, cols, existingTable = null) {
            ...
            for (let r = 0; r < rows; r++) {
                ...
                for (let c = 0; c < cols; c++) {
                    let td;
                    // Populate cell with old value if available
                    if (
                        existingTable &&
                        existingTable.rows[r] &&
                        existingTable.rows[r].cells[c]
                    ) {
                        td = existingTable.rows[r].cells[c].cloneNode(true);
                    } else {
                ...
                removeRowBtn.title = 'Remove this row';
                removeRowBtn.style.cssText =
                    'margin-left:8px;padding:2px 6px;font-size:12px;border-radius:4px;border:1px solid #ddd;background:#fee;cursor:pointer;';
                ...
                tdRemove.style.border = 'none';
                tdRemove.style.padding = '0';
                tdRemove.style.width = '1%';
        ...
        // Setup controls for adding/removing rows/columns and removing specific columns
        function setupTableControls(table) {
            // Remove any previous toolbar and column delete row
            wrapper.querySelectorAll('.table-toolbar, .delete-col-header').forEach(el => el.remove());

            // RemoveColumn Header Row
            if (table.rows.length > 0) {
                const headerRow = document.createElement('tr');
                headerRow.className = 'delete-col-header';
                for (let c = 0; c < table.rows[0].cells.length - 1; c++) {
                    const btn = document.createElement('button');
                    btn.type = 'button';
                    btn.innerText = '✖';
                    btn.title = 'Remove this column';
                    btn.style.cssText =
                        'padding:2px 6px;font-size:12px;border-radius:4px;border:1px solid #ddd;background:#fee;cursor:pointer;margin-bottom:2px;';
                    btn.onclick = (e) => {
                        e.stopPropagation();
                ...
                // For the remove-row button column (empty)
                headerRow.appendChild(document.createElement('th'));
                table.parentNode.insertBefore(headerRow, table);
            }
            ...
            addRowBtn.style.cssText =
                'padding:4px 8px;border-radius:4px;border:1px solid #ccc;background:#eef;cursor:pointer;';
            addRowBtn.onclick = () => {
                const cols = table.rows[0]?.cells.length - 1 || 1;
                const tr = document.createElement('tr');
                for (let c = 0; c < cols; c++) {
            ...
            addColBtn.onclick = () => {
                for (let r = 0; r < table.rows.length; r++) {
                    // Insert before the last cell (remove-row button)
                    const td = document.createElement('td');
                    td.contentEditable = true;
                    td.innerText = 'Cell';
                    td.style.padding = '8px';
                    ...
                    table.rows[r].insertBefore(td, table.rows[r].cells[table.rows[r].cells.length - 1]);
                }
                setupTableControls(table);
                saveState();
                refreshAllListViews();
            ...
            wrapper.insertBefore(toolbar, wrapper.firstChild.nextSibling || wrapper.firstChild);
        }
        ...
        // Actually add the block wrapper to the editor
        wrapBlock(wrapper, 'table');
    ...
    function addButtons() {
        ...
        function createButton() {
            ...
            removeBtn.onclick = (e) => {
                e.stopPropagation();
                wrap.removeChild(btnWrapper);
                // If only + remains, add back a button
                if (wrap.querySelectorAll('span').length === 0) {
                    wrap.insertBefore(createButton(), wrap.querySelector('.btn-add-inline'));
                }
            };
        ...
        function createAddButton() {
            ...
            addBtn.innerText = '+';
            addBtn.title = 'Add another button';
            addBtn.style.cssText = 'margin-left:4px;padding:0 8px;font-size:20px;line-height:1;border:1px solid #eee;background:#fafafe;color:#444;cursor:pointer;border-radius:4px;vertical-align:middle;';
            return addBtn;
        }

        function appendAddButton() {
            // Remove any old add buttons to avoid duplicates
            const priorAddBtns = wrap.querySelectorAll('.btn-add-inline');
            priorAddBtns.forEach(btn => btn.remove());
            // Only show add button at the end
            const addBtn = createAddButton();
            wrap.appendChild(addBtn);
            addBtn.onclick = () => {
                // Add a new button before the + button
                const btn = createButton();
                wrap.insertBefore(btn, addBtn);
                appendAddButton();
                // Focus just the new button, inner element is index 0
    ...
    function addImageBlock(initialImageSrc = null) {
        const wrap = document.createElement('div');
        wrap.className = 'block-image-inner';

        function renderImageActions() {
            // UI for upload/select/url/replace buttons
            wrap.innerHTML = `
        ...
        function renderWithImage(imageSrc) {
            ...
            wrap.innerHTML = `
                        <div style="position:relative; text-align:center;">
                            ...
                            <button type="button" class="btn-secondary block-img-replace" style="position:absolute;top:8px;right:8px;z-index:2;" title="Replace Image">
            ...
            // Always show a replace button for both create and edit
        ...
        if (initialImageSrc) {
            renderWithImage(initialImageSrc);
        } else {
            renderImageActions();
        }
    ...
    function showBlockToolbar(block) {
        ...
        const cssClassInput = document.getElementById('blockCssClass');
        const customCssInput = document.getElementById('blockCustomCss');
        const anchorInput = document.getElementById('blockHtmlAnchor');
        if (cssClassInput) cssClassInput.value = block.dataset.extraClass || '';
        if (customCssInput) customCssInput.value = block.dataset.customCss || '';
        if (anchorInput) anchorInput.value = block.id || '';
    }
    ...
    function applyFontSize(value) {
        ...
        if (sel && sel.rangeCount > 0 && !sel.isCollapsed) {
            ...
            if (selectedBlockContent.contains(range.commonAncestorContainer)) {
    ...
    function applyInlineStyleToSelection(styleKey, styleValue) {
        if (!selectedBlockContent) return false;
        const sel = window.getSelection();
        if (!sel || sel.rangeCount === 0 || sel.isCollapsed) return false;
        const range = sel.getRangeAt(0);
        if (!selectedBlockContent.contains(range.commonAncestorContainer)) return false;
    ...
    function sanitizeFragmentHtml(html) {
        const wrap = document.createElement('div');
        wrap.innerHTML = html || '';
        const allowedTags = new Set(['P', 'DIV', 'SPAN', 'STRONG', 'B', 'EM', 'I', 'U', 'A', 'UL', 'OL', 'LI', 'H1', 'H2', 'H3', 'H4', 'H5', 'H6', 'BLOCKQUOTE', 'PRE', 'CODE', 'BR', 'IMG']);
        const allowedStyle = new Set(['color', 'font-size', 'font-weight', 'font-style', 'text-decoration', 'text-align', 'background-color', 'margin', 'margin-top', 'margin-right', 'margin-bottom', 'margin-left', 'padding', 'padding-top', 'padding-right', 'padding-bottom', 'padding-left', 'border', 'border-width', 'border-style', 'border-color', 'border-radius', 'width', 'height']);
        ...
        const cleanNode = (node) => {
            ...
            [...node.attributes].forEach(attr => {
                ...
                if (!['href', 'src', 'alt', 'title', 'target', 'rel', 'style'].includes(n)) {
            ...
            if (node.hasAttribute('style')) {
                ...
                node.getAttribute('style').split(';').forEach(pair => {
                    ...
                    const v = p[1].trim();
                    if (allowedStyle.has(k) && v) safe.push(`${k}: ${v}`);
                });
        ...
        Array.from(wrap.children).forEach(cleanNode);
        return wrap.innerHTML;
    }

    function openPasteModal(targetEl, html, text) {
        pendingPaste = {
            targetEl,
            html: html || '',
            text: text || ''
        };
        if (window.bootstrap && document.getElementById('pasteCleanModal')) {
            pasteModalInstance = pasteModalInstance || new bootstrap.Modal(document.getElementById('pasteCleanModal'));
            pasteModalInstance.show();
        } else {
            const clean = window.confirm('Clean HTML?');
            applyPendingPaste(clean);
        }
    }

    function applyPendingPaste(clean) {
        if (!pendingPaste || !pendingPaste.targetEl) return;
        pendingPaste.targetEl.focus();
        const payload = clean ? sanitizeFragmentHtml(pendingPaste.html || pendingPaste.text) : (pendingPaste.html || pendingPaste.text);
        document.execCommand('insertHTML', false, payload);
        pendingPaste = null;
        saveState();
    }

    function applySelectedBlockAdvancedSettings() {
        if (!selectedBlock) return;
        const extraClass = (selectedBlock.dataset.extraClass || '').trim();
        selectedBlock.className = 'block';
        if (extraClass) {
            extraClass.split(/\s+/).filter(Boolean).forEach(cls => selectedBlock.classList.add(cls));
        }
    }
    ...
    document.getElementById('tbColor').addEventListener('input', (e) => {
        if (selectedBlockContent) {
            const appliedToSelection = applyInlineStyleToSelection('color', e.target.value);
    ...
    document.getElementById('blockBgColor')?.addEventListener('input', (e) => {
        if (selectedBlockContent) {
            const appliedToSelection = applyInlineStyleToSelection('backgroundColor', e.target.value);
            if (!appliedToSelection) {
    ...
    document.getElementById('blockCustomCss')?.addEventListener('input', (e) => {
        if (!selectedBlock) return;
        selectedBlock.dataset.customCss = e.target.value || '';
        applySelectedBlockAdvancedSettings();
        saveState();
    });
    document.getElementById('blockCssClass')?.addEventListener('input', (e) => {
        if (!selectedBlock) return;
        selectedBlock.dataset.extraClass = e.target.value || '';
        applySelectedBlockAdvancedSettings();
        saveState();
    });
    document.getElementById('blockHtmlAnchor')?.addEventListener('input', (e) => {
        if (!selectedBlock) return;
        selectedBlock.id = (e.target.value || '').trim();
        applySelectedBlockAdvancedSettings();
        saveState();
    });
    ...
    async function saveContent(publish = false) {
        ...
        for (const b of blocksRaw) {
            ...
            =============================== */
                ...
                const items = [];
                b.querySelectorAll('.btn-inline').forEach(btn => {
                    items.push({
                        text: (btn.innerText || '').trim(),
                        url: btn.dataset.url || '',
                        target: btn.dataset.linkTarget || '_self',
                        rel: btn.dataset.rel || '',
                        className: btn.className || 'btn-inline primary',
                ...
                const table = b.querySelector('table.editor-table, table');
                if (!table) {
                    blocks.push({
                        type: 'table',
                        content: ''
                    ...
                    Array.from(tableClone.rows).forEach((row, rowIndex) => {
                        if (row.cells.length) {
                            ...
                            const originalLastCell = originalRow && originalRow.cells.length ? originalRow.cells[originalRow.cells.length - 1] : null;
                            if (originalLastCell && originalLastCell.querySelector('button')) {
                    ...
                    blocks.push({
                        type: 'table',
                        content: cleanHTML(tableClone.outerHTML)
                    });
                }
            }
            /* ===============================
    ...
    if (document.getElementById('tbTextSection') && !document.getElementById('tbAlignJustify')) {
        const alignRightBtn = document.getElementById('tbAlignRight');
        const justifyBtn = document.createElement('button');
        justifyBtn.type = 'button';
        justifyBtn.className = 'tb-btn';
        justifyBtn.id = 'tbAlignJustify';
        justifyBtn.title = 'Justify';
        justifyBtn.textContent = '☰';
        alignRightBtn?.insertAdjacentElement('afterend', justifyBtn);
    }
    if (document.getElementById('tbTextSection') && !document.getElementById('tbUnderline')) {
        const italicBtn = document.getElementById('tbItalic');
        const underlineBtn = document.createElement('button');
        underlineBtn.type = 'button';
        underlineBtn.className = 'tb-btn';
        underlineBtn.id = 'tbUnderline';
        underlineBtn.title = 'Underline';
        underlineBtn.innerHTML = '<u>U</u>';
        italicBtn?.insertAdjacentElement('afterend', underlineBtn);
    }
    document.getElementById('tbAlignJustify')?.addEventListener('click', () => {
        if (!selectedBlockContent) return;
        selectedBlockContent.style.textAlign = 'justify';
        saveState();
    });
    ...
    function loadInitialBlocks(blocksData) {
        ...
        blocksData.forEach(b => {
            ...
            if (type === 'columns' || type === 'grid') {
                ...
                // Use same renderImageActions and renderWithImage as in addImageBlock for consistency
                function renderImageActions() {
                ...
                function renderWithImage(imageSrc) {
                    ...
                    wrap.innerHTML = `
                                <div style="position:relative; text-align:center;">
                                    <img src="${imageSrc}" alt="" style="max-width:100%;margin:auto;display:block;">
                                    <button type="button" class="btn-secondary block-img-delete" style="position:absolute;top:8px;right:8px;z-index:2;width:28px;height:28px;padding:0;display:flex;align-items:center;justify-content:center;border-radius:50%;" title="Delete Image">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="none" viewBox="0 0 24 24">
                                            <circle cx="12" cy="12" r="12" fill="#fff" style="opacity:0.95"/>
                                            <path d="M6.7 6.7l10.6 10.6M17.3 6.7L6.7 17.3" stroke="#e53e3e" stroke-width="2" stroke-linecap="round"/>
                                        </svg>
                                    </button>
                                    <button type="button" class="btn-secondary block-img-replace" style="position:absolute;top:44px;right:8px;z-index:2;" title="Replace Image">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none" viewBox="0 0 24 24"><path d="M20 17.17V13a1 1 0 1 1 2 0v7a1 1 0 0 1-1 1h-7a1 1 0 1 1 0-2h4.17L4.93 4.93a1 1 0 0 1 1.41-1.41l15.13 15.13a1 1 0 0 1-1.41 1.41L20 17.17z" fill="#555"/><path d="M2 6.83V11a1 1 0 1 0 2 0V6.83L19.07 19.07a1 1 0 0 0 1.41-1.41L4.93 4.93A1 1 0 1 0 3.51 6.34L2 6.83z" fill="#555"/></svg>
                                    </button>
                                </div>
                            `;
                    ...
                    let erroredOrInvalid = false;
                    if (img) {
                        img.onerror = function() {
                            erroredOrInvalid = true;
                            alert('The image could not be loaded or is corrupted. Please try a different image.');
                            renderImageActions();
                        };
                        img.onload = function() {
                            if (!img.naturalWidth || !img.naturalHeight) {
                                // Successfully fetched but corrupt or blank
                                erroredOrInvalid = true;
                                alert('The loaded image appears to be invalid or blank.');
                                renderImageActions();
                            }
                        };
                    } else {
                    ...
                    // Delete
                    const deleteBtn = wrap.querySelector('.block-img-delete');
                    if (deleteBtn && img) {
                ...
                function bindActions() {
                    wrap.querySelector('.block-img-upload').onclick = () => wrap.querySelector('.block-img-file').click();
                    wrap.querySelector('.block-img-file').onchange = function(e) {
                        const file = e.target.files[0];
                        if (file) {
                            const reader = new FileReader();
                            reader.onload = (ev) => {
                ...
                const url = b.url || '';
                // Show image if valid, otherwise show actions
                ...
                console.log('Processing buttons:', b);
                const wrap = document.createElement('div');
                wrap.className = 'block-buttons-inner';
                ...
                const buildButton = (item = {}) => {
                    ...
                    const btn = document.createElement('button');
                    btn.type = 'button';
                    btn.className = item.className || 'btn-inline primary';
                    btn.contentEditable = true;
                    btn.innerText = (item.text || '').trim() || 'Button';
                    btn.dataset.url = item.url || '';
                    btn.dataset.linkTarget = item.target || '_self';
                    btn.dataset.rel = item.rel || '';
                    btn.style.marginRight = '8px';
                    ...
                    removeBtn.onclick = (e) => {
                        e.stopPropagation();
                        btnWrapper.remove();
                        if (!wrap.querySelector('.btn-inline')) {
                            wrap.insertBefore(buildButton(), wrap.querySelector('.btn-add-inline'));
                        }
                    };
                ...
                const createAddButton = () => {
                    ...
                    addBtn.onclick = () => {
                        ...
                        wrap.insertBefore(newBtn, addBtn);
                        newBtn.querySelector('button')?.focus();
                    };
                    return addBtn;
                };
                ...
                if (!items.length) {
                    ...
                    items.forEach(item => wrap.appendChild(buildButton(item)));
                }
                wrap.appendChild(createAddButton());
                wrapBlock(wrap, 'buttons');
            } else if (type === 'table') {
                console.log('Processing table:', b);
                const wrap = document.createElement('div');
                wrap.className = 'wp-table-setup';
                const tmp = document.createElement('div');
                tmp.innerHTML = b.content || '';
                const table = tmp.querySelector('table') || document.createElement('table');
    ...
    // Keyboard shortcuts
    document.addEventListener('keydown', (e) => {
        if (e.key === 'Tab' && selectedBlock && selectedBlock.dataset.type === 'list' && isEditingContext()) {
            e.preventDefault();
            document.execCommand(e.shiftKey ? 'outdent' : 'indent');
            saveState();
            return;
        }
        if ((e.ctrlKey || e.metaKey) && e.key.toLowerCase() === 'b' && isEditingContext()) {
            e.preventDefault();
            document.execCommand('bold');
            saveState();
            return;
        }
        if ((e.ctrlKey || e.metaKey) && e.key.toLowerCase() === 'i' && isEditingContext()) {
            e.preventDefault();
            document.execCommand('italic');
            saveState();
            return;
        }
        if ((e.ctrlKey || e.metaKey) && e.key.toLowerCase() === 'u' && isEditingContext()) {
            e.preventDefault();
            document.execCommand('underline');
            saveState();
            return;
    ...
    editor.addEventListener('paste', (e) => {
        const targetEl = e.target?.closest?.('[contenteditable="true"]');
        if (!targetEl) return;
        ...
        e.preventDefault();
        openPasteModal(targetEl, html, text);
    });

    document.getElementById('pasteCleanBtn')?.addEventListener('click', () => {
        applyPendingPaste(true);
        pasteModalInstance?.hide();
    });
    document.getElementById('pasteKeepBtn')?.addEventListener('click', () => {
        applyPendingPaste(false);
        pasteModalInstance?.hide();
    });
</script>
